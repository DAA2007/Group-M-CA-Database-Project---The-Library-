...
# Borrows data
# Borrows (ID, Title, DateOfBorrow, ReturnTime, IsOverdue?)
insert into Borrows(BookID, Title, DateOfBorrow, ReturnTime, IsOverdue)
values
	(1, 'Nineteen Eighty-Four', '2026-01-05', '2026-01-19', true),
	(2, 'Pride and Prejudice', '2026-01-06', '2026-01-20', true),
	(3, 'To Kill a Mockingbird', '2026-01-07', '2026-01-21', true),
	(4, 'The Great Gatsby', '2026-01-08', '2026-01-22', true),
	(5, 'The Catcher in the Rye', '2026-01-09', '2026-01-23', true),
	(6, 'Animal Farm', '2026-01-10', '2026-01-24', true),
	(7, 'The Hobbit', '2026-01-11', '2026-01-25', true),
	(8, 'Harry Potter and the Philosopher''s Stone', '2026-01-12', '2026-01-26', true),
	(9, 'Harry Potter and the Chamber of Secrets', '2026-01-13', '2026-01-27', true),
	(10, 'Harry Potter and the Prisoner of Azkaban', '2026-01-14', '2026-01-28', true),
	(11, 'Harry Potter and the Goblet of Fire', '2026-01-15', '2026-01-29', true),
	(12, 'Harry Potter and the Order of the Phoenix', '2026-01-16', '2026-01-30', true),
	(13, 'Harry Potter and the Half-Blood Prince', '2026-01-17', '2026-01-31', true),
	(14, 'Harry Potter and the Deathly Hallows', '2026-01-18', '2026-02-01', true),
	(15, 'The Fellowship of the Ring', '2026-01-19', '2026-02-02', true),
	(16, 'The Two Towers', '2026-01-20', '2026-02-03', true),
	(17, 'The Return of the King', '2026-01-21', '2026-02-04', true),
	(18, 'The Da Vinci Code', '2026-01-22', '2026-02-05', true),
	(19, 'The Fault in Our Stars', '2026-01-23', '2026-02-06', true),
	(20, 'Gone Girl', '2026-01-24', '2026-02-07', true),
	(21, 'The Goldfinch', '2026-01-25', '2026-02-08', true),
	(22, 'The Road', '2026-01-26', '2026-02-09', true),
	(23, 'A Game of Thrones', '2026-01-27', '2026-02-10', true),
	(24, 'The Girl on the Train', '2026-01-28', '2026-02-11', true),
	(25, 'Life of Pi', '2026-01-29', '2026-02-12', true),
	(26, 'The Kite Runner', '2026-01-30', '2026-02-13', true),
	(27, 'The Book Thief', '2026-01-31', '2026-02-14', true),
	(28, 'Memoirs of a Geisha', '2026-02-01', '2026-02-15', true),
	(29, 'The Lovely Bones', '2026-02-02', '2026-02-16', true),
	(30, 'All the Light We Cannot See', '2026-02-03', '2026-02-17', true),
	(31, 'Nineteen Eighty-Four', '2026-02-04', '2026-02-18', true),
	(32, 'Pride and Prejudice', '2026-02-05', '2026-02-19', true),
	(33, 'To Kill a Mockingbird', '2026-02-06', '2026-02-20', true),
	(34, 'The Great Gatsby', '2026-02-07', '2026-02-21', true),
	(35, 'The Catcher in the Rye', '2026-02-08', '2026-02-22', true),
	(36, 'Animal Farm', '2026-02-09', '2026-02-23', true),
	(37, 'The Hobbit', '2026-02-10', '2026-02-24', true),
	(38, 'Harry Potter and the Philosopher''s Stone', '2026-02-11', '2026-02-25', true),
	(39, 'Harry Potter and the Chamber of Secrets', '2026-02-12', '2026-02-26', true),
	(40, 'Harry Potter and the Prisoner of Azkaban', '2026-02-13', '2026-02-27', true),
	(41, 'Harry Potter and the Goblet of Fire', '2026-02-14', '2026-02-28', true),
	(42, 'Harry Potter and the Order of the Phoenix', '2026-02-15', '2026-03-01', true),
	(43, 'Harry Potter and the Half-Blood Prince', '2026-02-16', '2026-03-02', true),
	(44, 'Harry Potter and the Deathly Hallows', '2026-02-17', '2026-03-03', true),
	(45, 'The Fellowship of the Ring', '2026-02-18', '2026-03-04', true),
	(46, 'The Two Towers', '2026-02-19', '2026-03-05', true),
	(47, 'The Return of the King', '2026-02-20', '2026-03-06', true),
	(48, 'The Da Vinci Code', '2026-02-21', '2026-03-07', true),
	(49, 'The Fault in Our Stars', '2026-02-22', '2026-03-08', true),
	(50, 'Gone Girl', '2026-02-23', '2026-03-09', true),
	(51, 'The Goldfinch', '2026-02-24', '2026-03-10', true),
	(52, 'The Road', '2026-02-25', '2026-03-11', true),
	(53, 'A Game of Thrones', '2026-02-26', '2026-03-12', true),
	(54, 'The Girl on the Train', '2026-02-27', '2026-03-13', true),
	(55, 'Life of Pi', '2026-02-28', '2026-03-14', true),
	(56, 'The Kite Runner', '2026-03-01', '2026-03-15', true),
	(57, 'The Book Thief', '2026-03-02', '2026-03-16', true),
	(58, 'Memoirs of a Geisha', '2026-03-03', '2026-03-17', true),
	(59, 'The Lovely Bones', '2026-03-04', '2026-03-18', true),
	(60, 'All the Light We Cannot See', '2026-03-05', '2026-03-19', true),
	(61, 'Nineteen Eighty-Four', '2026-03-06', '2026-03-20', true),
	(62, 'Pride and Prejudice', '2026-03-07', '2026-03-21', true),
	(63, 'To Kill a Mockingbird', '2026-03-08', '2026-03-22', true),
	(64, 'The Great Gatsby', '2026-03-09', '2026-03-23', true),
	(65, 'The Catcher in the Rye', '2026-03-10', '2026-03-24', true),
	(66, 'Animal Farm', '2026-03-11', '2026-03-25', true),
	(67, 'The Hobbit', '2026-03-12', '2026-03-26', true),
	(68, 'Harry Potter and the Philosopher''s Stone', '2026-03-13', '2026-03-27', true),
	(69, 'Harry Potter and the Chamber of Secrets', '2026-03-14', '2026-03-28', true),
	(70, 'Harry Potter and the Prisoner of Azkaban', '2026-03-15', '2026-03-29', true),
	(71, 'Harry Potter and the Goblet of Fire', '2026-03-16', '2026-03-30', true),
	(72, 'Harry Potter and the Order of the Phoenix', '2026-03-17', '2026-03-31', true),
	(73, 'Harry Potter and the Half-Blood Prince', '2026-03-18', '2026-04-01', true),
	(74, 'Harry Potter and the Deathly Hallows', '2026-03-19', '2026-04-02', false),
	(75, 'The Fellowship of the Ring', '2026-03-20', '2026-04-03', false),
	(76, 'The Two Towers', '2026-03-21', '2026-04-04', false),
	(77, 'The Return of the King', '2026-03-22', '2026-04-05', false),
	(78, 'The Da Vinci Code', '2026-03-23', '2026-04-06', false),
	(79, 'The Fault in Our Stars', '2026-03-24', '2026-04-07', false),
	(80, 'Gone Girl', '2026-03-25', '2026-04-08', false),
	(81, 'The Goldfinch', '2026-03-26', '2026-04-09', false),
	(82, 'The Road', '2026-03-27', '2026-04-10', false),
	(83, 'A Game of Thrones', '2026-03-28', '2026-04-11', false),
	(84, 'The Girl on the Train', '2026-03-29', '2026-04-12', false),
	(85, 'Life of Pi', '2026-03-30', '2026-04-13', false),
	(86, 'The Kite Runner', '2026-03-31', '2026-04-14', false),
	(87, 'The Book Thief', '2026-04-01', '2026-04-15', false),
	(88, 'Memoirs of a Geisha', '2026-04-02', '2026-04-16', false),
	(89, 'The Lovely Bones', '2026-04-03', '2026-04-17', false),
	(90, 'All the Light We Cannot See', '2026-04-04', '2026-04-18', false),
	(91, 'Nineteen Eighty-Four', '2026-04-05', '2026-04-19', false),
	(92, 'Pride and Prejudice', '2026-04-06', '2026-04-20', false),
	(93, 'To Kill a Mockingbird', '2026-04-07', '2026-04-21', false),
	(94, 'The Great Gatsby', '2026-04-08', '2026-04-22', false),
	(95, 'The Catcher in the Rye', '2026-04-09', '2026-04-23', false),
	(96, 'Animal Farm', '2026-04-10', '2026-04-24', false),
	(97, 'The Hobbit', '2026-04-11', '2026-04-25', false),
	(98, 'Harry Potter and the Philosopher''s Stone', '2026-04-12', '2026-04-26', false),
	(99, 'Harry Potter and the Chamber of Secrets', '2026-04-13', '2026-04-27', false),
	(100, 'Harry Potter and the Prisoner of Azkaban', '2026-04-14', '2026-04-28', false),
	(101, 'Harry Potter and the Goblet of Fire', '2026-04-15', '2026-04-29', false),
	(102, 'Harry Potter and the Order of the Phoenix', '2026-04-16', '2026-04-30', false),
	(103, 'Harry Potter and the Half-Blood Prince', '2026-04-17', '2026-05-01', false),
	(104, 'Harry Potter and the Deathly Hallows', '2026-04-18', '2026-05-02', false),
	(105, 'The Fellowship of the Ring', '2026-04-19', '2026-05-03', false),
	(106, 'The Two Towers', '2026-04-20', '2026-05-04', false),
	(107, 'The Return of the King', '2026-04-21', '2026-05-05', false),
	(108, 'The Da Vinci Code', '2026-04-22', '2026-05-06', false),
	(109, 'The Fault in Our Stars', '2026-04-23', '2026-05-07', false),
	(110, 'Gone Girl', '2026-04-24', '2026-05-08', false),
	(111, 'The Goldfinch', '2026-04-25', '2026-05-09', false),
	(112, 'The Road', '2026-04-26', '2026-05-10', false),
	(113, 'A Game of Thrones', '2026-04-27', '2026-05-11', false),
	(114, 'The Girl on the Train', '2026-04-28', '2026-05-12', false),
	(115, 'Life of Pi', '2026-04-29', '2026-05-13', false),
	(116, 'The Kite Runner', '2026-04-30', '2026-05-14', false),
	(117, 'The Book Thief', '2026-05-01', '2026-05-15', false),
	(118, 'Memoirs of a Geisha', '2026-05-02', '2026-05-16', false),
	(119, 'The Lovely Bones', '2026-05-03', '2026-05-17', false),
	(120, 'All the Light We Cannot See', '2026-05-04', '2026-05-18', false),
	(121, 'Nineteen Eighty-Four', '2026-05-05', '2026-05-19', false),
	(122, 'Pride and Prejudice', '2026-05-06', '2026-05-20', false),
	(123, 'To Kill a Mockingbird', '2026-05-07', '2026-05-21', false),
	(124, 'The Great Gatsby', '2026-05-08', '2026-05-22', false),
	(125, 'The Catcher in the Rye', '2026-05-09', '2026-05-23', false),
	(126, 'Animal Farm', '2026-05-10', '2026-05-24', false),
	(127, 'The Hobbit', '2026-05-11', '2026-05-25', false),
	(128, 'Harry Potter and the Philosopher''s Stone', '2026-05-12', '2026-05-26', false),
	(129, 'Harry Potter and the Chamber of Secrets', '2026-05-13', '2026-05-27', false),
	(130, 'Harry Potter and the Prisoner of Azkaban', '2026-05-14', '2026-05-28', false),
	(131, 'Harry Potter and the Goblet of Fire', '2026-05-15', '2026-05-29', false),
	(132, 'Harry Potter and the Order of the Phoenix', '2026-05-16', '2026-05-30', false),
	(133, 'Harry Potter and the Half-Blood Prince', '2026-05-17', '2026-05-31', false),
	(134, 'Harry Potter and the Deathly Hallows', '2026-05-18', '2026-06-01', false),
	(135, 'The Fellowship of the Ring', '2026-05-19', '2026-06-02', false),
	(136, 'The Two Towers', '2026-05-20', '2026-06-03', false),
	(137, 'The Return of the King', '2026-05-21', '2026-06-04', false),
	(138, 'The Da Vinci Code', '2026-05-22', '2026-06-05', false),
	(139, 'The Fault in Our Stars', '2026-05-23', '2026-06-06', false),
	(140, 'Gone Girl', '2026-05-24', '2026-06-07', false),
	(141, 'The Goldfinch', '2026-05-25', '2026-06-08', false),
	(142, 'The Road', '2026-05-26', '2026-06-09', false),
	(143, 'A Game of Thrones', '2026-05-27', '2026-06-10', false),
	(144, 'The Girl on the Train', '2026-05-28', '2026-06-11', false),
	(145, 'Life of Pi', '2026-05-29', '2026-06-12', false),
	(146, 'The Kite Runner', '2026-05-30', '2026-06-13', false),
	(147, 'The Book Thief', '2026-05-31', '2026-06-14', false),
	(148, 'Memoirs of a Geisha', '2026-06-01', '2026-06-15', false),
	(149, 'The Lovely Bones', '2026-06-02', '2026-06-16', false),
	(150, 'All the Light We Cannot See', '2026-06-03', '2026-06-17', false);
